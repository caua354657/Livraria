...
<div class="d-flex justify-content-center align-items-center min-vh-100">
   <div class="container-alterar">
    ...
    <div class="card bg-primary text-white">
        <div class="card-body"><center><b>Alterar Cliente</b></center></div>
    </div>
    ...
    <form action="#" enctype="multipart/form-data" method="POST">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                <label for="nascimento">🗓️ Data Nascimento</label>
        ...
        <div class="row g-2">
            <div class="col-6">
                <div class="d-grid">
                    <a href="gerenciar_usuario.php" type="button" class="btn btn-secondary">Voltar</a>
                </div>
            </div>
            <div class="col-6">
                <div class="d-grid">
           ...
           if(!empty($_FILES['imagem']['name']))
            {
                if(move_uploaded_file($_FILES['imagem']['tmp_name'], $uploadfile))
                {
                    $sqlup = "update cliente set foto_perfil = '$imagem', nome = '$nome', data = '$data', email = '$email' where id_cliente = $id";
                        ...
                        {
                            header("refresh: 1; url=gerenciar_usuario.php");
