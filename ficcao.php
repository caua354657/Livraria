...
<link rel="stylesheet" href="css/ficcao.css">
</head>
<body>
...
?>
    ...
    <br>
    <h2 class="text-center mb-4 titulo-animado">🎭 Ficção</h2>
...
$sql = "select * from livro where id_categoria = 4 and titulo like '%$livro%' order by rand() limit 12";
